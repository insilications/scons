...
Source0  : https://sourceforge.net/projects/scons/files/scons/3.0.2/scons-3.0.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1546451175
...
/usr/lib/scons/scons-3.0.2-py2.7.egg-info/PKG-INFO
/usr/lib/scons/scons-3.0.2-py2.7.egg-info/SOURCES.txt
/usr/lib/scons/scons-3.0.2-py2.7.egg-info/dependency_links.txt
/usr/lib/scons/scons-3.0.2-py2.7.egg-info/top_level.txt
...
/usr/bin/scons-configure-cache-3.0.2
/usr/bin/scons-time
/usr/bin/scons-time-3.0.2
/usr/bin/sconsign
/usr/bin/sconsign-3.0.2
