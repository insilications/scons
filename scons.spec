...
Source0  : https://sourceforge.net/projects/scons/files/scons/3.0.4/scons-3.0.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548256732
...
/usr/lib/scons/scons-3.0.4-py2.7.egg-info

%files bin
%defattr(-,root,root,-)
/usr/bin/scons
/usr/bin/scons-3.0.4
/usr/bin/scons-3.0.4.bat
/usr/bin/scons-configure-cache
/usr/bin/scons-configure-cache-3.0.4
/usr/bin/scons-time
/usr/bin/scons-time-3.0.4
/usr/bin/scons.bat
/usr/bin/sconsign
/usr/bin/sconsign-3.0.4
