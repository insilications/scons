...
Version  : 3.0.3
Release  : 27
URL      : https://sourceforge.net/projects/scons/files/scons/3.0.3/scons-3.0.3.tar.gz
Source0  : https://sourceforge.net/projects/scons/files/scons/3.0.3/scons-3.0.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1546934455
...
/usr/lib/scons/scons-3.0.3-py2.7.egg-info

%files bin
%defattr(-,root,root,-)
/usr/bin/scons
/usr/bin/scons-3.0.3
/usr/bin/scons-3.0.3.bat
/usr/bin/scons-configure-cache
/usr/bin/scons-configure-cache-3.0.3
/usr/bin/scons-time
/usr/bin/scons-time-3.0.3
/usr/bin/scons.bat
/usr/bin/sconsign
/usr/bin/sconsign-3.0.3
